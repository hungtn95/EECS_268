...
int main()
{
    ...
    while (done == 'n')
    {
		...
		else if (choice == 2)
		{
			...
			ChickenPtr->setName("Chicken");
			ChickenPtr->setSound("Cluck");
		...
		else if (choice == 3)
		{
			...
			CyberChickenPtr->setName("Cyber Chicken");
			CyberChickenPtr->setSound("Resistance is futile");
			int eggs;
